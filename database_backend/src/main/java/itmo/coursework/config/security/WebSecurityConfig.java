    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .and()
                    ...
                    .antMatchers(HttpMethod.PUT, "/databases/staff").hasAnyAuthority(Role.ADMIN.name())
                    .antMatchers(HttpMethod.POST, "/databases/staff").hasAnyAuthority(Role.ADMIN.name())
                    .antMatchers(HttpMethod.DELETE, "/databases/staff").hasAnyAuthority(Role.ADMIN.name())
